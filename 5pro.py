...
midd=["u4a0f653ea757da7abcd41c15bf0f15da"]
midd2=["u53c352134325f0c49e86534c57801bd7"]
midd3=["ud5262649376cbf7576e2dcac0331d481"]
midd4=["uadfd3a23698b71d17c64482d27dc2ed1"]
midd5=["uc6a6ba43d1ce45e5c78fc7fb37afd17e"]
midd6=["ud74066bb0bc042125f6da564f576d683"]
midd7=["u7b8ce44a6f9d630388280e817775111f"]
midd8=["ua2ea9f4c32848bc67644c5267bb91279"]
midd9=["u412728dbaf91158d3787b7de2aaf5be8"]
...
#--------------------------------------------------------
                ...
                return
#--------------------------------------------------------
            elif "K spamtag @" in msg.text:
                if msg.from_ in owner:
                    _name = msg.text.replace("K spamtag @","")
                    _nametarget = _name.rstrip(' ')
                    gs = kr1.getGroup(msg.to)
                    for g in gs.members:
                        if _nametarget == g.displayName:
            ...
            elif msg.text in ["K glist"]: #Melihat List Group
                if msg.from_ in owner:
            ...
            elif "K asupka " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("K asupka ","")
                    if gid == "":
