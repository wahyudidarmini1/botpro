...
if (six.PY2):
    ...
    import urllib.parse
acil = PRANKBOTS.LINE()
acil.login(token="EsRLc1tyPho3fbz6HTn8.BQIP++PfVBkYt2USSm1tMa.4SUALoprItQg5uhUKsJFlffZU5nhrTnJSz9WJ3JnoiI=")
acil.loginResult()
ki = PRANKBOTS.LINE()
ki.login(token="EsJv1fGZx4disyWvuTN4./0DOo/10A+PUJG8iHA76Pa.1npBTzVj3Kczdu0BWIvfbckntJZBf3Bfs/8s2yYBnhQ=")
ki.loginResult()
ki2= PRANKBOTS.LINE()
ki2.login(token="EsmjYOcUje7RV6dI39J4.bOiJimUzjLhiapSWdVjeva.d6m5po3UUgBrjZChgVI/L/LRESnnC+sf5Jy47LCwB24=")
ki2.loginResult()
ki3 = PRANKBOTS.LINE()
ki3.login(token="Esq8RW4xANugRfKszg5b.DQKC4akNYSJx6AqIuzyS6W.VSws7+stcGvRZBeQVa2VwJciTp2RKzJksT8HkDAs5nc=")
ki3.loginResult()
ki4 = PRANKBOTS.LINE()
ki4.login(token="EsTE3qIejwkGyC2uFxb5.s0GaOrjP6Vfn98NxODhvLq.4tzMdMQRgV7wm2NL9o+rYH11dHIw1JrVAywWLaOhGEg=")
ki4.loginResult()
ki5 = PRANKBOTS.LINE()
ki5.login(token="EsstGdXPGCUl7bnT3ee1.hSPlQK0sOlldo8W2iFcJWq.KGw/KYqp+kMEBKjHebt76UibNG+yxnJgBWQvQ7bQ9OM=")
print "login success"
reload(sys)
...
admsa = "ufb47683bed746bfa6e8e0f0885aefaa4" #MID SELFBOT
PRANKBOT = ["u6ea8a9fffa45bdb2b24f6bacb0cd5398"] #MID OWNER
wait = {
    'contact':False,
    'autoJoin':True,
